/* 
1. Sort() akan mengurutkan elemen array. Lalu menimpa array asli. Elemen diurutkan sesuai abjad.
...
// const number1 = [15,11,13,250,152,22]
// number1.sort()
// console.log(number1)

// const number2 = [15,11,13,250,152,22]
// number2.sort(function (a,b) { return a-b })
// console.log(number2)
// console.log("----------------------------------------------")
/* 
2. find() akan me-return nilai elemen pertama yang lulus pengujian. find() akan mengeksekusi setiap elemen array. Jika tidak ada elemen yang ditemukan, find() akan me-return undefined.
...
// console.log("----------------------------------------------")
/*
3. filter() akan membuat array baru yang isi elemen nya didapat dari hasil eksekusi yang lulus pengujian. filter() tidak me replace array asli
*/
...
// console.log("----------------------------------------------")
/*
4. concat() akan menggabungkan 2 atau lebih data. Lalu akan mereturn hasil baru yang elemen nya terdapat dalam 2 atau lebih data yang digabungkan tadi.
...
// console.log("----------------------------------------------")
/* 
5. toString() akan mengubah data menjadi string. Biasanya dipakai jika ingin menampilkan data sebagai teks. Tidak dapat digunakan kepada object */
...
// console.log("----------------------------------------------")
/* 
6. isInteger() akan mengecek apakah data tersebut bilangan bulat atau tidak. Lalu akan mereturn data boolean true jika benar dan false jika salah
*/
...
// console.log("----------------------------------------------")
/*
7. includes() akan mengecek data apakah data tersebut berisi data yang ditentukan. jika iya maka akan me-return true jika tidak maka akan me-return false. perlu diingat bahwa
...
// console.log("----------------------------------------------")
/*
8. replace() akan mengganti nilai string yang ditentukan dengan nilai string yang baru. lalu mereturn string baru yang telah diubah
*/
...
// console.log("----------------------------------------------")
/*
9. substring() akan mengambil string pada posisi yang ditentukan lalu akan mereturn string baru yang berada pada range yang telah di buat
*/
...
// console.log("----------------------------------------------")
/*
10. toLowerCase() akan mengubah string menjadi huruf kecil
*/
